...
class mantenimiento_controller extends Controller
{
    ...
    {
        $cortesia = cortesias_activacion::with(['cotizacion', 'mecanico'])->find(decrypt_id($id));
    ...
    public function create_vue_mantenimiento(Request $request)
    {
        ...
        if ($create) {
            ...
            $cortesias_activacion->is_aviso = 'A';
            ...
            return response()->json([
                ...
                'error' => '',
                'success' => true,
                'data' => route('mantenimiento.show', encrypt_id($cortesias_activacion->cortesias_activacion_id)),
            ]);
        } else {
