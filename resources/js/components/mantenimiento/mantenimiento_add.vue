        ...
        <div class="card">
            <form id="form_crear_mantenimiento" method="POST" action="#" >
                ...
                <div class="card-body">
                                ...
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text">
                                            <Checkbox name="is_aviso" v-on:click="is_aviso_change" id="is_aviso" v-model="is_aviso"
                                                :binary="true" />
                                        </span>
                                    </div>
                                    <p-inputnumber name="dias" :disabled="isDisabledDias" id="dias" v-model="dias"
                                        inputId="minmax-buttons" :useGrouping="false" showButtons
                                        :min="0" :max="1000" />
                                    <div class="input-group-prepend">
                        ...
                        <div class="form-row">
                            <mantenimientoAccesorios :accesorios="accesorios" @childEvent="add_accesorios"></mantenimientoAccesorios>
                        </div>
