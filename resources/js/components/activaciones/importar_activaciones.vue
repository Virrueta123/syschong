<template>
    ...
    <div class="section-body">
        <div class="card">
            <form id="form_importar_producto" method="POST" action="#" enctype="multipart/form-data">
                    ...
                    <div class="card text-left">
                        <div class="card-body">
                            <div class="section-header">
                                <h1>Importar los activaciones</h1>
                            </div>
    ...
    export default {
        ...
        mounted() {
            ...
            this.uppy = new Uppy({
                ...
                .use(XHRUpload, {
                    endpoint: '/importar_activaciones', // Ruta de la API en Laravel que manejará la carga de archivos
                    formData: true,
                    headers: {
            ...
            $("#form_importar_producto").validate({
                rules: {
                    unidades_id: {
                        required: true,
                    }
