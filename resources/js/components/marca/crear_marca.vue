                ...
                <div class="modal-content">
                    <form id="form_marca" method="POST" action="#">
                        <div class="modal-header">
                            <h5 class="modal-title" id="modal-crear-marca-label">Formulario para crear una Marca</h5>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="card-body">
                                ...
                                <h2 class="section-title">Crear Marca</h2>
                                <div class="form-row">
                                    <div class="form-group col-md-12">
                                        <label for="marca_nombre">Nombre de la Marca</label>
                                        <input type="text" v-model="marca_nombre" class="form-control" name="marca_nombre"
                                            id="marca_nombre">
                                    </div>
