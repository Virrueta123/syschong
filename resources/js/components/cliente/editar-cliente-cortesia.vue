            ...
            <div class="modal-content">
                <form id="form_cliente" method="POST" action="#">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="card-body">
                            <div id="app">
                                <dni :cli_dni="cliente.cli_dni" :cli_nombre="cliente.cli_nombre" :cli_apellido="cliente.cli_apellido" :cli_direccion="cliente.cli_direccion"
                                    :cli_departamento="cliente.cli_departamento" :cli_provincia="cliente.cli_provincia" :cli_distrito="cliente.cli_distrito"></dni>
                                <ruc :cli_ruc="cliente.cli_ruc" :cli_razon_social="cliente.cli_razon_social" :cli_direccion_ruc="cliente.cli_direccion_ruc" :cli_departamento_ruc="cliente.cli_departamento_ruc"
                                    :cli_provincia_ruc="cliente.cli_provincia_ruc" :cli_distrito_ruc="cliente.cli_distrito_ruc"></ruc>
                            </div>
                            <h2 class="section-title">Contactos</h2>
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <label for="cli_telefono">Celular</label>
                                    <input type="text" class="form-control" :value="cliente.cli_telefono" name="cli_telefono"
                                        id="cli_telefono">
                                </div>

                                <div class="form-group col-md-6">
                                    <label for="cli_correo">Correo Electronico</label>
                                    <input type="email" class="form-control" name="cli_correo" :value="cliente.cli_correo" id="cli_correo">
                                </div>
                            </div>
