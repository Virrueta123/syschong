            ...
            <div class="card-body">
                ...
                <form id="form_compra" action="#" method="post">
                    ...
                    <div class="form-row ">
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <div class="input-group">
                                <search-proveedor
                                    :selected="'Ruc ' + compra.proveedor.proveedor_ruc + '/ R.social ' + compra.proveedor
                                        .proveedor_razon_social + '/ Dni ' + compra.proveedor.proveedor_dni +
                                        '/ Nombre ' + compra.proveedor.proveedor_nombre"
                                    :id_proveedor="compra.proveedor_id" id="proveedor_id">
                                </search-proveedor>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-8">
                            ...
                            <select name="tipo_comprobante" v-on:change="tipo_comprobante($event)" class="form-control">
                                <option :selected="compra.t_comprobante == 'F'" value="F" checked>Factura
                                    Electronica
                                </option>
                                <option :selected="compra.t_comprobante == 'B'" value="B">Boleta Electronica
                                </option>
                                <option :selected="compra.t_comprobante == 'N'" value="N">Nota de Venta</option>
                            </select>
                        </div>

                        <div class="form-group col-md-2">
                            <label>Serie</label>
                            <input type="text" name="serie" v-model="serie" class="form-control">
                        </div>

                        <div class="form-group col-md-2">
                            <label>Correlativo</label>
                            <input type="text" name="correlativo" v-model="correlativo" class="form-control">
                        </div>
                    ...
                    <button type="submit" name="" id=""
                        class="btn btn-primary btn-lg btn-block">Editar Compra</button>
                </form>
                    ...
                    <form id="agregar_producto" method="POST" action="#">
                        ...
                        <div class="modal-footer">
                            <button class="btn btn-secondary" id="crear_cliente_cerrar" data-dismiss="modal">Cerrar
                                Formulario</button>
                            <button type="submit" class="btn btn-primary" id="crear_cliente">crear Compra</button>
                        </div>
                    </form>
                </div>
            </div>
    ...
    export default {
        ...
        data() {
            return {
                ...
                compra: JSON.parse(this.$attrs.compra) || '',
                show_productos: [],
                timeoutId: null,
                repuestos: [],
                total: 0,
        ...
        methods: {
            ...
            eliminar_producto(identificador) {
                ...
                if (indice !== -1) {
                    ...
                    this.delete.push(this.repuestos[indice].prod_id)
                    this.calcular_total();
                }
            },
            calcular_total() {
        ...
        mounted() {
            ...
            this.is_pago = this.compra.is_pago == "Y" ? true : false;

            
            this.compra.pagos.forEach(element => {
                console.log(element)
                this.pagos.push({
                    monto:  element.monto,
                    forma_pago_id:  element.forma_pago_id,
                    referencia: element.referencia,
                    url: element.imagen == "Y" ? true : false,
            ...
            this.compra.detalle.forEach(element => {
                ...
                this.repuestos.push({
                    prod_id: element.producto.prod_id,
                    Codigo: element.producto.prod_codigo,
                    Descripcion: element.producto.prod_nombre,
                    unidad: element.producto.unidad.unidades_nombre,
                    Precio: element.precio_compra,
                    precio_compra: element.precio_compra,
                    precio_venta: element.precio_venta,
                    Cantidad: element.cantidad,
                    zona_id: element.zona_id,
                    zona_nombre: element.zona.zona_nombre,
                    is_precio_venta: element.is_precio_venta,
                    is_precio_compra: element.is_precio_compra,
                    Importe: element.cantidad * element.precio_compra,
                })
            });

            this.fecha_creacion = this.compra.fecha_emision;
            this.fecha_vencimiento = this.compra.fecha_vencimiento;

            this.serie = this.compra.compra_serie;
            this.correlativo = this.compra.compra_correlativo;
