<template>
    ...
    <div class="section-body">
        <div class="card">
            <form id="form_importar_servicios" method="POST" action="#" enctype="multipart/form-data">
    ...
    export default {
        ...
        mounted() {
            ...
            this.uppy = new Uppy({
                ...
                .use(XHRUpload, {
                    endpoint: '/importar_servicios', // Ruta de la API en Laravel que manejará la carga de archivos
                    formData: true,
                    headers: {
            ...
            $("#form_importar_servicios").validate({
                rules: {
                    unidades_id: {
                        required: true,
                    }
