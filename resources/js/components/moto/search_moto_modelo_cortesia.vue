        ...
        <div class="form-group col-md-8 mt-4">
            <div class="input-group">
                ...
                <div class="buttons p-2">
                    ...
                    <button class="btn btn-primary boton-color" v-on:click="modal_create()" type="button"><i
                            ...
                            <form id="form_moto" method="POST" action="#">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-4">
                                                ...
                                                <input type="text" class="form-control" name="mtx_placa"
                                                    id="mtx_placa">
                                            </div>

                                            <div class="form-group col-md-4">
                                                <label for="mtx_vin">Vin</label>
                                                <input type="text" class="form-control" name="mtx_vin"
                                                    id="mtx_vin">
                                            </div>
                                            <div class="form-group col-md-4">
                                                <label for="mtx_motor">Motor</label>
                                                <input type="text" class="form-control" name="mtx_motor"
                                                    id="mtx_motor">
                                            </div>
                                        </div>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="btn-group" data-toggle="buttons">
                                                        <label class="btn btn-primary" id="#azul">
                                                            <input type="radio" name="mtx_color" value="azul">
                                                            Azul
                                                        </label>
                                                        <label class="btn btn-warning">
                                                            <input type="radio" name="mtx_color" value="amarillo">
                                                            Amarillo
                                                        </label>
                                                        <label class="btn btn-danger">
                                                            <input type="radio" name="mtx_color" value="rojo">
                                                            Rojo
                                                        </label>
                                                        <label class="btn btn-dark">
                                                            <input type="radio" name="mtx_color" value="negro">
                                                            Negro
                                                        </label>
                                                        <label class="btn btn-light">
                                                            <input type="radio" name="mtx_color" value="blanco">
                                                            Blanco
                                                        </label>
                                                    </div>
                                                </div>
                                ...
                                <div class="card-footer">
                                    <button type="submit" id="crear_cliente"
                                        class="btn btn-danger boton-color">Crear
                                        Moto
                                    </button>
                                </div>
                            </form>
                    ...
                    <CModalBody>
                        ...
                        <div class="card">
                            ...
                            <form id="form_edit_celular" method="POST" action="#">
                                <div class="card-body">
                                    <div class="form-row">
                                        <div class="form-group col-md-12">
                                            ...
                                            <input type="text" name="cli_telefono" id="cli_telefono"
                                ...
                                <div class="card-footer">
                                    <button type="submit" id="crear_cliente"
                                        class="btn btn-danger boton-color">Actualizar
                                        Telefono
                                    </button>
                                </div>
                            </form>
                ...
                axios
                    ...
                    .then((response) => {
                        ...
                        if (response.data.success) {
                            ...
                            this.cortesia_de_empezar =  this.moto.cortesia;
