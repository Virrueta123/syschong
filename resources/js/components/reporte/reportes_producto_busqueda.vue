<template>
    ...
    <div class="card mb-0 pt-2 pt-md-0">
        <div class="card-header bg-danger">
            <h3 class="my-0 text-white">Consulta de documentos por producto</h3>
                            ...
                            <div class="row mt-2">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <div class="buttons">
                                            ...
                                            <button v-on:click="buscar_data()" v-if="pro_id!=0 && por_mes" class="btn btn-icon icon-left btn-primary"><i
                                                class="fa fa-search"></i>
                                            Buscar</button>
                              
                                            <button v-on:click="buscar_data()" v-if="pro_id!=0 && start_mounth && end_mounth && entres_meses" class="btn btn-icon icon-left btn-primary"><i
                                                class="fa fa-search"></i>
                                            Buscar</button>
                                       
                                            <button v-on:click="buscar_data()" v-if="pro_id!=0 && fecha_por_date && por_fecha" class="btn btn-icon icon-left btn-primary"><i
                                                class="fa fa-search"></i>
                                            Buscar</button>
                                       
                                            <button v-on:click="buscar_data()" v-if="pro_id!=0 && start_date && end_date && entre_fechas" class="btn btn-icon icon-left btn-primary"><i
                                                class="fa fa-search"></i>
                                            Buscar</button>
    ...
    export default {
        ...
        computed: {
            async load_data() {
                ...
                axios
                    .post("/load_data_documento_producto_individual", data, {
                        headers,
                    })
                    .then((response) => {
