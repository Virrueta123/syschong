        ...
        <div class="card-body">
            ...
            <form id="form_cortesia_creando_activacion" method="POST" action="#">
                ...
                <div class="card-header">
                    <h2 class="section-title">Formulario para crear la garantia de una moto</h2>
                </div>
                <div class="card-body">
                    <div id="app">

                        <h2 class="section-title">Seleccionar activacion</h2>
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    <searchActivacion @activacionChild="activacion_child"></searchActivacion>
                                </div>
                            </div>
                        ...
                        <repuestosAddGarantia :servicios_defecto="servicios_defecto" :productos_defecto="productos_defecto"
                            v-on:childEvent="handleChildEvent">
                        </repuestosAddGarantia>
...
<script>
    ...
    import repuestosAddGarantia from "../repuestos/add_repuesto_garantia.vue"
    ...
    export default {
        ...
        mounted() {
            ...
            $("#form_cortesia_creando_activacion").validate({
                rules: {
                    mtx_id: {
                        required: true,
                    },
                    ...
                    if (this.select_acesorios.length != 0) {
                        if (this.select_autorizacion.length) {
                            try {
                                ...
                                axios
                                    .post("/create_vue_garantia_orden", data, {
                                        headers,
                                    })
                                    .then((response) => {
