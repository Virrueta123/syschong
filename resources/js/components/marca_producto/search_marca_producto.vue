<template>
    ...
    <select name="marca_prod_id" id="marca_select_producto" ref="marca_select_producto" class="form-control custom-select" style="width: 100"
    ...
    export default {
        ...
        mounted() { 
            ...
            $(this.$refs.marca_select_producto).select2({
                ...
                ajax: {
                    type: 'POST',
                    url: "/marca_producto_search", // Replace with your API endpoint URL
                    dataType: "json", 
