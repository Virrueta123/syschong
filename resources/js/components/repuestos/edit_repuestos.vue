            ...
            this.detalle.forEach(elemento => {
                ...
                if (elemento.tipo=="s") {
                    this.repuestos.push({
                        prod_id: 0,
                        tipo: "s",
                        servicios_id: elemento.servicios_id,
                    ...
                    this.repuestos.push({
                        prod_id: elemento.prod_id,
                        tipo: "p",
                        servicios_id: 0,
                        Codigo:elemento.Codigo,
                        Descripcion:elemento.Descripcion,
                        Detalle:elemento.Detalle,
                        unidad:elemento.producto.unidad.unidades_nombre,
                        Precio:elemento.Precio,
                        Descuento: 0,
                        ValorDescuento: 0,
                        Cantidad:elemento.Cantidad,
