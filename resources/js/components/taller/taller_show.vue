                ...
                <div class="col-md-12">
                    ...
                    <TabView  >
                        ...
                        <TabPanel header="Pendiente aprobacion">
                            <h3 class="text-center"><i class="fa fa-screwdriver-wrench"></i>  Pendiente aprobacion </h3>
                            <div class="table-responsive">
                                    <table class="table table-sm table-bordered table-hover" id="table-pendiente-aprobacion">
                                        <thead>
                                            <tr>
                                                <th scope="col">Cliente</th>
                                                 <th scope="col">Dni/Ruc</th>
