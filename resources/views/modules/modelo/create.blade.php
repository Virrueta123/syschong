...
@section('content')
    <div class="section-body">
        <div class="card">
            <form id="form_modelo" method="POST" action="{{ route('modelo.store') }}">
                @csrf
                @if ($errors->any())
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control" name="modelo_nombre" id="modelo_nombre">
                            </div>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input-money name_precio="precio_gasolina"></input-money>
                                </div>
                            </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select name="tipo_vehiculo_id" class="form-control">
                                    @foreach ($tipo_vehiculo as $tv)
                                        <option {{ $tipo_vehiculo_select->tipo_vehiculo_id == $tv->tipo_vehiculo_id ? "seleted" : "" }} value="{{ $tv->tipo_vehiculo_id }}">{{ $tv->tipo_vehiculo_nombre }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
