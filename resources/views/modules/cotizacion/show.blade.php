...
@section('content')
    <div id="app">
        ...
        <cotizacion-mantenimiento fecha="{{$fecha}}" url_whatsapp="{{$url_whatsapp}}" accesorios="{{$accesorios}}" autorizaciones="{{$autorizaciones}}"  url_raiz="{{$url_raiz}}" id="{{$id}}" forma_pago="{{$forma_pago}}" correlativo_factura="{{$correlativo_factura}}" correlativo_boleta="{{$correlativo_boleta}}" empresa="{{$empresa}}" cotizacion="{{ $get }}" />
