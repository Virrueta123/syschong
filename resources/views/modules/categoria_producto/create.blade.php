...
@section('historial')
    ...
    <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item"><a href="{{ route('cliente.index') }}" class="text-danger">Categorias</a></div>
...
@section('content')
    <div class="section-body">
        <div class="card">
            <form id="form_cliente" method="POST" action="{{ route('categorias.store') }}">
                @csrf
                @if ($errors->any())
                ...
                <div class="card-header">
                    <h2 class="section-title">Formulario para crear una categoria de producto</h2>
                </div>
                <img src="{{ asset("images/svg/crear_formulario.svg") }}" alt="My Happy SVG" />
