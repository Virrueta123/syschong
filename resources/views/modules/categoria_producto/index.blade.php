...
@section('historial')
    ...
    <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item"><a href="{{ route('categorias.index') }}" class="text-danger">Categorias de producto</a></div>
...
@section('content')
    <div class="card">
        <div class="card-header">
            <h4  >Tabla de registros de las categoria</h4>
            <div class="card-header-action">
            
                <a href="{{ route('categorias.create') }}" class="btn btn-primary boton-color">Crear una categoria</a> 
