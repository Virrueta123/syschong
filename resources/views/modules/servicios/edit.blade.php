...
@section('historial')
    ...
    <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item">Editando Servicio</div>
    </div>
@endsection
@section('content')
    <div class="section-body">
        <div class="card">
            <form id="form_activaciones" method="POST" action="{{ route('servicios.update',$id) }}">
                @csrf
                @method('PUT')
                @if ($errors->any())
                ...
                <div class="card-header">
                    <h2 class="section-title">Formulario para editar un Servicio</h2>
                </div>
                <div class="card-body">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" name="servicios_nombre" value="{{ $get->servicios_nombre }}" id="servicios_nombre">
                        </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <div id="app">
                                    <input-money valor="{{ $get->servicios_precio }}" name_precio="servicios_precio"></input-money>
                                </div>  
                            </div>
                        </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <textarea name="servicios_descripcion" class="form-control" id="servicios_descripcion" cols="30" rows="10">{{ $get->servicios_descripcion }}</textarea> 
                        </div>
