<td class="p-2 d-inline-block" style="justify-content: center;">
    <div class="row d-flex flex-row">
        ...
        <a class="btn btn-info btn-sm m-1" href="{{ route('producto.show', $prod_id) }}"> <i class="fa fa-eye fa-1x"></i>
        </a>

        <a class="btn btn-info btn-sm m-1" href="{{ route('producto.edit', $prod_id) }}"> <i class="fa fa-edit fa-1x"></i>
        </a>
