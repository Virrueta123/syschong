<div class="dropdown d-inline">
    ...
    <div class="dropdown-menu" x-placement="bottom-start"
        ...
        <a class="dropdown-item" target="_blank" href="{{ route('tienda.reporte_factura', $tienda_facturas_id) }}"> <i class="fa fa-edit fa-1x"></i>Ver Reporte
        </a>
        ...
        <a class="dropdown-item p-0 pl-2">
            <form method="POST" id="formdeletetx{{ $venta_id }}"
                ...
                <button type="submit" style="width: 100%"
                    onclick="FormDelete('tx{{ $venta_id }}','esta segur@ que desea eliminar esta factura',event)"
